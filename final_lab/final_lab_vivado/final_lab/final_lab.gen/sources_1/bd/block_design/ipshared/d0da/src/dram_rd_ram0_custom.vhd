...
architecture arch of dram_rd_ram0_custom is
    ...
    signal data_high, data_low   : std_logic_vector(15 downto 0);
...
begin
    ...
    swap_data <= dram_rd_data;
    data_high <= dram_rd_data(31 downto 16);
    data_low <= dram_rd_data(15 downto 0);
