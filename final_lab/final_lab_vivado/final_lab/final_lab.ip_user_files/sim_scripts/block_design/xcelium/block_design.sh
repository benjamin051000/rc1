...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../final_lab.gen/sources_1/bd/block_design/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../final_lab.gen/sources_1/bd/block_design/ipshared/f42d/hdl" \
       +incdir+"../../../../final_lab.gen/sources_1/bd/block_design/ipshared/ec67/hdl" \
       +incdir+"../../../../final_lab.gen/sources_1/bd/block_design/ipshared/f42d/hdl" \
       +incdir+"D:/XiLink/Vivado/2021.1/data/xilinx_vip/include"
}
